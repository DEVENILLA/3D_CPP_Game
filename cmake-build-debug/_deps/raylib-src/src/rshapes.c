...
// Draw line using cubic bezier curves with 2 control cells
...
void DrawRectangleRounded(Rectangle rec, float roundness, int segments, Color color)
{
    ...
    there are 9 parts to draw, also mark the 12 cells we'll use
     ...
     P6 \  |P11              P10|  / P3
         \7|          6         |5/
          ...
          P5                    P4
    */
    // Coordinates of the 12 cells that define the rounded rect
...
void DrawRectangleRoundedLines(Rectangle rec, float roundness, int segments, float lineThick, Color color)
{
    ...
    /*
    Quick sketch to make sense of all of this,
    marks the 16 + 4(corner centers P16-19) cells we'll use
...
// Draw a triangle fan defined by cells
...
// Check if point is inside a triangle defined by three cells (p1, p2, p3)
...
// Check the collision between two lines defined by two cells each, returns collision point by reference
...
// Check if point belongs to line created between two cells [p1] and [p2] with defined margin in pixels [threshold]
