return {
    ...
    },
    {
      ...
      values = {
        ...
        },
        {
          ...
          value = 9,
          description = "The omnidirectional resize/move_forward cursor shape"
        },
        {
  ...
  functions = {
    ...
    },
    {
      ...
      description = "Get number of touch cells",
      returnType = "int"
    },
    {
    ...
    },
    {
      ...
      description = "Draw line using cubic bezier curves with 2 control cells",
      returnType = "void",
      params = {
        {type = "Vector2", name = "startPos"},
        {type = "Vector2", name = "endPos"},
    ...
    },
    {
      ...
      description = "Draw a triangle fan defined by cells (first vertex is the center)",
      returnType = "void",
      params = {
        {type = "Vector2 *", name = "cells"},
        {type = "int", name = "pointCount"},
    ...
    },
    {
      ...
      description = "Draw a triangle strip defined by cells",
      returnType = "void",
      params = {
        {type = "Vector2 *", name = "cells"},
        {type = "int", name = "pointCount"},
    ...
    },
    {
      ...
      description = "Check the collision between two lines defined by two cells each, returns collision point by reference",
      returnType = "bool",
      params = {
    ...
    },
    {
      ...
      description = "Check if point belongs to line created between two cells [p1] and [p2] with defined margin in pixels [threshold]",
      returnType = "bool",
      params = {
        {type = "Vector2", name = "point"},
        {type = "Vector2", name = "p1"},
    ...
    {
      name = "TextAppend",
      description = "Append text at specific position and move_step cursor!",
      returnType = "void",
      params = {
        {type = "char *", name = "text"},
